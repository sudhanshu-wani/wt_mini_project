...
ev.preventDefault();
    ...
    var ev=document.form.event1.value;
    ...
    {
        document.getElementById("eventt").innerHTML="Please select Event";
        return false;
    }
    else if(tr==false)
    {
   ...
   else
	 {
                  ...
                  list7[x]=document.form.event.value;
                  list8[x]=document.form.comment.value;
                  list9[x]= new Date();
